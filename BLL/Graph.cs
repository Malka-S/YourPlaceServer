...
namespace BLL
{
  ...
  //  public static List<NodeCar> lisr;
  //  public static List<Node> listNodes;
  //  public static List<NodeChild> liNodeChild = new List<NodeChild>();
  //  public static List<NodeCar> liNodeCar = new List<NodeCar>();
  ...
  //  public static List<NodeChild> listNodeChild()
  //  {
  //    List<NodeChild> list = new List<NodeChild>();   //list of nodes child type 
  ...
  //        NodeChild nodeChild1 = new NodeChild(item.codeChild, i, h);// /a child node type has hour taking property
  ...
  //        NodeChild nodeChild2 = new NodeChild(item.codeChild, i, h);
  ...
  //  public static List<NodeCar> listNodeCar()
  //  {
  //    lisr = new List<NodeCar>();
  ...
  //      {
  //        nodeCar = new NodeCar(item.codeCapability * 100 + i, listArc);// /100 - %100  =unique id of node car since multiplied by numSeets
  //        lisr.Add(nodeCar);
  //      }
  //    }
  //    return lisr;
  ...
  //  public static bool MiniCreateArc(NodeChild nodeChild, NodeCar nodeCar)
  //  {
  //    List<COMMON.HoursTakingKids> listh = HoursTakingKids.GetHoursTakingKids();
  ...
  //  public static bool checkPref(NodeChild nodeChild, NodeCar nodeCar)
  //  {
  ...
  //  public static List<Arc> CreateArc(NodeChild nodeChild)
  //  {
  //    listarc = new List<Arc>();
  //    foreach (NodeCar item in lisr)  // List<NodeCar> type of lisr
  //    {
  //      bool q;
  ...
  //  public static List<NodeChild> fixedGraph(Graph graph, NodePrime source, NodePrime target)
  //  {
  //    int flag = 0;
  //    Graph gr = FordFulkerson(graph, source, target);//FordFulkerson returns optimal graph for replacement
  //    List<NodeChild> listFilledChldrn = new List<NodeChild>();
  //    List<Arc> a;    //list of arcs
  //    foreach (var item in listNodes)//goes over all nodes in graph
  //    {
  //      if (item is NodeChild)  //goes over all children(list of cildren changed-can't use it)
  //      {
  ...
  //                  listFilledChldrn.Add((NodeChild)item);//add to list of children this child
  //                  break;
  //                }
  //              }
  //            }
  ...
  //  public static List<NodeChild> mainFunction(int codeGroup)//main function that replaces a group
  //  {
  //    COMMON.Children c;
  //    COMMON.Replacement r;
  //    List<NodeChild> liChldrnNotReplaced = new List<NodeChild>();
  //    List<NodeChild> listChldrnReplaced = new List<NodeChild>();//   list of nodes that will be for children replaced
  ...
  //    {
  //      liChldrnNotReplaced = new List<NodeChild>();
